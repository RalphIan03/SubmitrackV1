    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6">
        ...
        <form class="space-y-4">
            ...
            <div>
                ...
                <select name="" id="" class="w-full border rounded-lg px-4 py-2 focus:ring-gold focus:border-gold">
                    <option value="DBA">DBA</option>
                    <option value="DBA">DTE</option>
                    <option value="DBA">DTP</option>
                    <option value="DBA">DAS</option>
                    <option value="DBA">DAE</option>
                    <option value="DBA">DHE</option>
                </select>
            </div>
